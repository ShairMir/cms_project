                            ...
                            <tbody>
                                ...
                                if (isset($connection)) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($select_comments)) {
                                        ...
                                        echo "<td class='text-center'><a onClick=\"javascript: return confirm('Are you sure you want to delete this comment?')\" href='post_comments.php?delete=$comment_id&id=" . $_GET['id'] . "'><i class='fa fa-times fa-lg'></i></a></td>";
                                        echo "</tr>";
                                    }        
                                } 
